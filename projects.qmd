...
## Personal Value Ratings for Predidential Speeches
</div>
::::: {.columns .responsive-columns}

::: {.column width="50%"}

[Dashboard](https://vzvyvk-andrew-demetriou.shinyapps.io/Speeches_Dashboard/) · [<i class="bi bi-github"></i>](https://github.com/andrew0302/speeches_dashboard)
...
![](images/speeches_dashboard_2.png){width="100%" style="border-radius: 1rem; margin-bottom: 0.25rem;"}
</div>
:::
<div style="text-align: center;">
...
::: {.column width="50%" style="padding-left: 1rem;"}
<div style="padding: 0.25rem; border-radius: 0.25rem; margin-bottom: 0.5rem; margin-top:0,5rem;">
