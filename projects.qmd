...
::: {.column width="50%" style="padding-left: 1rem;"}
<div style="padding: 0.25rem; border-radius: 0.25rem; margin-bottom: 0.5rem;">
![](images/logo32white.svg){width="80%" style="float: right; margin-bottom: 0.25rem;"}
</div>
...
<div style="text-align: center;">
### Check out my other work on <span class="bi bi-google"></span> [Scholar](https://scholar.google.nl/citations?user=TFnVkFQAAAAJ&hl=en) and
</div>
